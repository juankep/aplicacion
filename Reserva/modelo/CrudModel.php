...
class CrudModel {
    ...
    public function getServicios() {
        ...
        $listado = array();
        foreach ($resultado as $res) {
            $servicio = new Servicio($res['idServicio'], $res['nombre'], $res['descripcion'], $res['caracteristicas'],
                    $res['presioServicio'],$res['estado'],$res['tipo'],$res['idCategoria']);
            array_push($listado, $servicio);
        }
        Database::disconnect();
        //retornamos el listado resultante:
        return $listado;
