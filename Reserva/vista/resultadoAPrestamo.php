...
$servicioCanasta="SELECT * FROM servicio l INNER JOIN reserva p ON (l.idServicio = p.idServicio) WHERE ci='".$cedula."';";
...
function mostrarBuscado(str)
	{
		...
		xmlhttp.open("GET","aReservaScript.php?q="+str,true);
		xmlhttp.send();
	}
</script>
<form name="formAPrestamo" action="aReservaScript.php" method="post">
<?php
	...
	echo("<tr><td><a class='tit'>Reserva Realizados:</a></td><td><a class='nom'><b><i>".$numeroDeReservas."<i></b></a></td></tr></table>");
	?>
	<br>
	<center>
		...
		<tr bgcolor="#EDA">
			...
			<td align="center"><a class="encabezadoTabla">Fecha de Atencion</a></td>
