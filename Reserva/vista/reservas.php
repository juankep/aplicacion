...
<form target="resultadosFechas" method="post" name="formFechas" action="historialReservas.php">
<table align="center">
<tr><td align="center"><font face="verdana"><b>Ingrese la Fecha para ver el historial:</b></font></td></tr>
<tr><td align="center">
	<select name="diaReserva" id="diaReserva"><?php for($j=1; $j<=31; $j++){ echo("<option value=" .$j. ">".$j. "</option>");}?></select>
		<select name="mesReserva" id="mesReserva">
		...
		<input type="text" name="annioReserva" id="annioReserva" style="width:50px;" placeholder="A&ntilde;o">
</td></tr>
<tr><td align="center"><input type="submit" class="boton" value="Examinar >>"></td></tr>
</table>
<br>
<center><iframe name="resultadosFechas" frameborder="0" src="historialReservas.php" width="800" height="500"></iframe></center>
</form>
<body>