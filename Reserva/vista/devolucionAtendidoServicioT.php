...
.enlaceboton:hover {
	...
	<form target="_top" action="trabajadores.php?<?php echo (session_name()); ?>=<?php echo (session_id()); ?>">
	...
	<form action="resultadoAtencionServicioAtendidoT.php" method="get" name="devolucion" target="devolucionFrame">
